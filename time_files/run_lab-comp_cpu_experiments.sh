...
echo "[lab-comp_cpu] Running dqn on minigrid | Ablation 6 | Run 2"
OMP_NUM_THREADS=16 CUDA_VISIBLE_DEVICES="" numactl --cpunodebind=0 --membind=0 python runner.py --algo dqn --env_name minigrid --ablation 6 --run 2 --device_name lab-comp_cpu
...
echo "[lab-comp_cpu] Running dqn on cartpole | Ablation 3 | Run 1"
OMP_NUM_THREADS=16 CUDA_VISIBLE_DEVICES="" numactl --cpunodebind=0 --membind=0 python runner.py --algo dqn --env_name cartpole --ablation 3 --run 1 --device_name lab-comp_cpu
